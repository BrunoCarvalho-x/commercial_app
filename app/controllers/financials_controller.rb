class FinancialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @financial.save
        format.html { redirect_to financial_url(@financial), notice: "Financial was successfully created." }
  ...
  def update
    respond_to do |format|
      if @financial.update(financial_params)
        format.html { redirect_to financial_url(@financial), notice: "Financial was successfully updated." }
